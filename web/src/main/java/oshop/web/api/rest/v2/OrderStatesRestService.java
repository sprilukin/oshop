...
public class OrderStatesRestService extends BaseRestService<OrderState, Integer> {

    @Resource
    private GenericService<OrderState, Integer> productService;
     ...
     * Delete orderState
     *
     * @param id the id of the orderState to remove
     * @return nothing
     */
    @RequestMapping(
            value = "/orderStates/{id}",
     ...
     *
     * @param id the id of the orderState
     * @return orderState
     */
    @RequestMapping(
            value = "/orderStates/{id}",
    ...
    /**
     * Update orderState with given id
     *
     * @param id the id of the orderState
     * @return orderState with updates
     */
    @RequestMapping(
            value = "/orderStates/{id}",
    ...
    public ResponseEntity<?> update(
            ...
            @RequestBody @Valid final OrderState entity, final BindingResult result) {
     ...
     * Add new orderState
     *
     * @param entity orderState
     * @param result binding result
     * @return newly created orderState
     */
    @RequestMapping(
            value = "/orderStates",
            ...
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public ResponseEntity<?> add(@RequestBody @Valid final OrderState entity, final BindingResult result) {
     ...
     */
    @RequestMapping(
            value = "/orderStates/{filter}/{sort}/{projection}",
            method = RequestMethod.GET,
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
