...
<h1><spring:message code="additional.payment.title"/></h1>
...
<div class="row-fluid span12 entity-controls">
    ...
    <div class="inline span3 offset6">
        <a href="#add" role="button" class="btn btn-primary">
            ...
            <spring:message code="additional.payment.add.payment"/>
        </a>
    </div>
</div>
...
<script data-main="additionalPayments/main" src="${pageContext.request.contextPath}/resources/js/lib/require.js"></script>
</body>
</html>
