...
@Controller
@RequestMapping("/api/v2/itemCategories")
@Transactional(readOnly = true)
public class ItemCategoryControllerV2 {

    private static final Log log = LogFactory.getLog(ItemCategoryControllerV2.class);
    ...
    public ResponseEntity<?> list(
        ...
        return new ReturningRestCallbackAdapter<List<ItemCategory>>() {
            @Override
