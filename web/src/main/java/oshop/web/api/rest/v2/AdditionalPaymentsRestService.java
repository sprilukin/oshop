...
public class AdditionalPaymentsRestService extends BaseRestService<AdditionalPayment, Integer> {

    @Resource
    private GenericService<AdditionalPayment, Integer> productService;
     ...
     *
     * @param id the id of the additionalPayment to remove
     * @return nothing
     */
    @RequestMapping(
            value = "/additionalPayments/{id}",
    ...
    /**
     * Get additionalPayment by id
     *
     * @param id the id of the additionalPayment
    ...
    /**
     * Update additionalPayment with given id
     *
     * @param id the id of the additionalPayment
     * @return additionalPayment with updates
     */
    @RequestMapping(
            value = "/additionalPayments/{id}",
    ...
    public ResponseEntity<?> update(
            ...
            @RequestBody @Valid final AdditionalPayment entity, final BindingResult result) {
    ...
    /**
     * Add new additionalPayment
     *
     * @param entity additionalPayment
     * @param result binding result
     * @return newly created additionalPayment
     */
    @RequestMapping(
            ...
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public ResponseEntity<?> add(@RequestBody @Valid final AdditionalPayment entity, final BindingResult result) {
        return super.add(entity, result);
    }

    /**
     * List additionalPayments
     *
     ...
     */
    @RequestMapping(
            value = "/additionalPayments/{filter}/{sort}",
            method = RequestMethod.GET,
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
     ...
     */
    @RequestMapping(
            value = "/additionalPayments/{filter}/{sort}/{projection}",
            method = RequestMethod.GET,
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
