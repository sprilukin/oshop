...
public class ProductCategoriesRestService extends BaseRestService<ProductCategory, Integer> {
    ...
    /**
     * Update productCategory with given id
     *
     * @param id the id of the productCategory
     * @return productCategory with updates
     */
    @RequestMapping(
            value = "/productCategories/{id}",
    ...
    public ResponseEntity<?> update(
            ...
            @RequestBody @Valid final ProductCategory entity, final BindingResult result) {
     ...
     *
     * @param entity productCategory
     * @param result binding result
     * @return newly created productCategory
     */
    @RequestMapping(
            ...
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public ResponseEntity<?> add(@RequestBody @Valid final ProductCategory entity, final BindingResult result) {
     ...
     */
    @RequestMapping(
            value = "/productCategories/{filter}/{sort}",
            method = RequestMethod.GET,
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
     ...
     */
    @RequestMapping(
            value = "/productCategories/{filter}/{sort}/{projection}",
            method = RequestMethod.GET,
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
